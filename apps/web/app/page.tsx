  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
        ...
        <section className="text-center flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-6 w-full pt-24 min-h-[calc(100vh-8rem)] flex flex-col items-center justify-center">
            ...
            <p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed max-w-3xl mx-auto mb-12">
              The future of prediction markets. Trade on real-world outcomes
        ...
        <section className="py-28" data-fade>
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <div className="flex justify-center">
              <Link
                href="/markets"
                className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/20 text-white px-6 py-3 text-base font-medium backdrop-blur transition-colors hover:bg-white/15"
              >
                Explore Markets
                <svg
                  className="h-4 w-4"
              ...
              {[
                  ...
                  icon: (
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M4 7h11m0 0L11 3m4 4L11 11M20 17H9m0 0l4-4m-4 4l4 4"
                      />
                    </svg>
                  )
                },
                  ...
                  icon: (
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M3 10h18M5 10V7a2 2 0 012-2h10a2 2 0 012 2v3m-2 0v7a2 2 0 01-2 2H9a2 2 0 01-2-2v-7"
                      />
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div
                      className={`rounded-xl border border-white/10 p-2 bg-gradient-to-br ${item.accentBg}`}
                    >
                      {item.icon}
                    </div>
                  </div>
                  <div
                    className={`text-xl bg-gradient-to-r bg-clip-text text-transparent ${item.accentText} mb-2`}
                  >
                    {item.title}
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent font-light">
                    Fees, Bonds, Incentives
                  </h3>
                </div>
                <ul className="text-gray-300/90 space-y-2 text-sm">
                  <li>
                    • Trade fee example 0.8% → LP 65% • Creator 20% • Protocol
                    15%
                  </li>
                  <li>• Settlement fee example 0.2% on payouts</li>
                  <li>
                    • Creation bond (e.g., 10 USDC) with timed refund; deters
                    spam
                  </li>
                  <li>
                    • Dispute bond scales with open interest to prevent
                    frivolous disputes
                  </li>
                </ul>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl bg-gradient-to-r from-emerald-300 to-cyan-300 bg-clip-text text-transparent font-light">
                    Why Sonic
                  </h3>
                </div>
                <ul className="text-gray-300/90 space-y-2 text-sm">
      ...
      <style jsx>{`
        ...
        .fade-on-scroll {
          opacity: calc(var(--vis, 0));
          transform: translateY(calc(24px * (1 - var(--vis, 0))));
